...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title><?php echo $api->get_title('list'); ?></title>
...
<meta name="theme-color" content="#7952b3">
    ...
    <link href="../frontend/Template · Bootstrap v5.1_files/dashboard.css" rel="stylesheet">
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="https://getbootstrap.com/docs/5.1/examples/dashboard/#">Admin sites</a>
...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="https://getbootstrap.com/docs/5.1/examples/dashboard/#">
        ...
        <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
          ...
          <a class="link-secondary" href="https://getbootstrap.com/docs/5.1/examples/dashboard/#" aria-label="Add a new report">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
      ...
      <h2>Domains for user: </h2><h4><?php  echo $_SESSION['user'];  ?></h4>
